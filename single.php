        ...
        <div class="grid gap-6 px-4 pb-8 pt-6 lg:grid-cols-12 sm:px-8">
          <section class="lg:col-span-9">
            ...
            <div class="mt-4 flex flex-wrap items-center gap-3">
              ...
              <a class="inline-flex h-9 w-9 items-center justify-center rounded-full border border-slate-200 bg-white text-slate-700 no-underline hover:bg-slate-50 hover:no-underline" href="#comments" aria-label="Comments">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="h-4 w-4"><path stroke-linecap="round" stroke-linejoin="round" d="M21 15a4 4 0 0 1-4 4H8l-5 3V7a4 4 0 0 1 4-4h10a4 4 0 0 1 4 4v8Z" /></svg>
              </a>
            </div>

            <div class="mt-6 overflow-hidden rounded-2xl bg-slate-100">
              <?php if (has_post_thumbnail()) : ?>
                <?php the_post_thumbnail('large', ['class' => 'h-[420px] w-full object-cover sm:h-[520px]']); ?>
              <?php else : ?>
                <div class="h-[420px] w-full bg-slate-100 sm:h-[520px]"></div>
              <?php endif; ?>
            </div>

            <div class="mt-8 space-y-5 text-[15px] leading-relaxed text-slate-800">
              <?php the_content(); ?>
            </div>
          ...
          <aside class="hidden lg:col-span-3 lg:block">
            <div class="lg:sticky lg:top-24 lg:h-fit">
              <div class="rounded-xl border border-slate-200 bg-white p-3">
                <div class="min-h-[520px] w-full rounded-lg bg-slate-50"></div>
              </div>
            </div>
          </aside>
        </div>
