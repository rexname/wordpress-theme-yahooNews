...
<main class="mx-auto max-w-6xl px-4 py-6">
  <header class="mb-6">
    <h1 class="text-2xl font-extrabold tracking-tight text-slate-900 md:text-3xl"><?php single_tag_title(); ?></h1>
  </header>

  <?php
  $term = get_queried_object();
  $termName = $term instanceof WP_Term ? $term->name : single_tag_title('', false);
  ...
  <div class="mt-10 grid gap-6 lg:grid-cols-12">
    <section class="lg:col-span-9">
      ...
      <div id="stories-list" class="space-y-5" data-tag-id="<?php echo esc_attr((string) $termId); ?>" data-next-offset="<?php echo esc_attr((string) $storiesNextOffset); ?>">
